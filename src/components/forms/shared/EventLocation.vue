<template>
    <div id="event-location-block" class="event-location border border-dsj-grey2 rounded-xl">
        <div class="location-header flex items-center justify-between bg-dsj-yellow-15 p-5 rounded-t-xl">

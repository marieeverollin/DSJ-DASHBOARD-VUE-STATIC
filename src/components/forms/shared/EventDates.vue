        ...
        <div class="event-date-list flex flex-col gap-y-5 p-5">
            <div v-for="(date, index) in dates" :key="index" class="event-date-item flex flex-col xl:flex-row xl:justify-between xl:items-center gap-5">
                ...
                <div class="flex flex-col 2xl:flex-row 2xl:items-center gap-5 xl:w-10/12 2xl:w-11/12">
                    <div class="input-group flex items-center gap-x-5 w-full 2xl:w-4/12">
                        <label for="date" class="text-dsj-grey4 flex w-4/12 xl:w-2/12 2xl:w-auto"> Event Date </label>
                    ...
                    <div class="input-group flex items-center gap-x-5 w-full 2xl:w-4/12">
                        <label for="start-time" class="text-dsj-grey4 flex w-4/12 xl:w-2/12 2xl:w-auto"> Start Time </label>
                    ...
                    <div class="input-group flex items-center gap-x-5 w-full 2xl:w-4/12">
                        <label for="end-time" class="text-dsj-grey4 flex w-4/12 xl:w-2/12 2xl:w-auto"> End Time </label>
            ...
            <div class="flex gap-5 flex-wrap xl:justify-between 2xl:justify-start">
                <div class="input-group flex items-center gap-x-5 w-full xl:w-4/12 2xl:w-3/12">
                ...
                <div v-if="repeatingEvent" class="input-group flex items-center gap-x-5 w-full xl:w-7/12">
                    <label for="repeatingFrequency" class="text-dsj-grey4 w-4/12 xl:w-5/12 2xl:w-4/12"> Repeat Frequency </label>
            ...
            <div class="flex gap-5 flex-wrap xl:justify-between 2xl:justify-start">
                ...
                <div v-if="!repeatOneYear" class="input-group flex items-center gap-x-5 w-full xl:w-7/12">
                    <label for="endingOn" class="text-dsj-grey4 w-4/12 xl:w-5/12 2xl:w-4/12"> Ending on </label>

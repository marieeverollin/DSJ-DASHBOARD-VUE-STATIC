        ...
        <div class="flex flex-col gap-y-5 p-5">
            <div v-for="(date, index) in dates" :key="index" class="flex flex-col xl:flex-row xl:items-center gap-5">
                ...
                <div class="input-group flex items-center gap-x-5 w-full xl:w-4/12">
                    ...
                    <DatePicker v-model="date.icondisplay" showIcon fluid iconDisplay="input" placeholder="Select" class="flex-1 rounded-md text-dsj-grey3 border border-dsj-grey2 p-2 shadow-none w-8/12 xl:w-full" />
                </div>
                ...
                <div class="input-group flex items-center gap-x-5 w-full xl:w-3/12">
                    ...
                    <DatePicker id="datepicker-timeonly" v-model="date.startTime" timeOnly fluid placeholder="Select" class="flex-2 rounded-md text-dsj-grey3 border border-dsj-grey2 p-2 shadow-none w-8/12 xl:w-full" />
                </div>

                <div class="input-group flex items-center gap-x-5 w-full xl:w-3/12">
                    <label for="end-time" class="text-dsj-grey4 flex w-4/12 xl:w-auto"> End Time </label>
                    <DatePicker id="datepicker-timeonly" v-model="date.endTime" timeOnly fluid placeholder="Select" class="flex-2 rounded-md text-dsj-grey3 border border-dsj-grey2 p-2 shadow-none w-8/12 xl:w-full" />
                </div>
            ...
            <div class="flex gap-5 flex-wrap">
                <div class="input-group flex items-center gap-x-5 w-full xl:w-3/12">
                    ...
                    <Checkbox v-model="repeatingEvent" inputId="repeatingEvent" name="repeatingEvent" :binary="true" value="repeatingEvent" class="w-8/12 xl:w-5/12" />
                </div>
                ...
                <div v-if="repeatingEvent" class="input-group flex items-center gap-x-5 w-full xl:w-5/12">
                    ...
                    <Select :key="repeatingEvent" v-model="repeatingFrequency" :options="repeatingFrequencyOptions" optionLabel="name" placeholder="Select" class="w-8/12 xl:w-full rounded-md text-dsj-grey3 border border-dsj-grey2 shadow-none" />
                </div>
            </div>
            ...
            <div class="flex gap-5 flex-wrap">
                <div class="input-group flex items-center gap-x-5 w-full xl:w-3/12">
                    ...
                    <Checkbox v-model="repeatOneYear" inputId="repeatOneYear" name="repeatOneYear" value="repeatOneYear" :binary="true" class="w-8/12 xl:w-5/12" />
                </div>
                ...
                <div v-if="!repeatOneYear" class="input-group flex items-center gap-x-5 w-full xl:w-5/12">
                    ...
                    <DatePicker v-model="endingOn" placeholder="Select Date" class="w-8/12 xl:w-full rounded-md text-dsj-grey3 border border-dsj-grey2 p-2 shadow-none" />
                </div>
            </div>
        </div>
    </div>

<template>
    <div id="custom-paragraph" class="border border-dsj-grey2 rounded-xl  mx-5">
        ...
        <div class="flex gap-x-5 p-2.5 md:p-5">
            <Textarea v-model="customParagraph" rows="5" cols="30" class="rounded-md text-dsj-grey3 border border-dsj-grey2 p-2 shadow-none w-full" />
        </div>
    </div>
</template>

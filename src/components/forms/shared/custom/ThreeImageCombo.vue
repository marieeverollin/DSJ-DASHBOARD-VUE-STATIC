    ...
    <div id="custom-image-combo" class="border border-dsj-grey2 rounded-xl  mx-5">
        ...
        <div class="flex flex-col gap-5 p-2.5 md:p-5">
            <div class="flex flex-col gap-2 lg:flex-row lg:items-center justify-between w-full">
                ...
                <Button v-if="fileSelected1" label="Delete" icon="pi pi-times" @click="removeImage(1)" class="delete-date w-fit items-center justify-center gap-x-2 bg-dsj-light-red text-white px-2.5 py-1.5 rounded-md text-xs uppercase h-fit" />
            </div>
            ...
            <div class="flex flex-col gap-2 lg:flex-row lg:items-center justify-between w-full">
                ...
                <Button v-if="fileSelected2" label="Delete" icon="pi pi-times" @click="removeImage(2)" class="delete-date w-fit items-center justify-center gap-x-2 bg-dsj-light-red text-white px-2.5 py-1.5 rounded-md text-xs uppercase h-fit" />
            </div>
            ...
            <div class="flex flex-col gap-2 lg:flex-row lg:items-center justify-between w-full">
                ...
                <Button v-if="fileSelected3" label="Delete" icon="pi pi-times" @click="removeImage(3)" class="delete-date w-fit items-center justify-center gap-x-2 bg-dsj-light-red text-white px-2.5 py-1.5 rounded-md text-xs uppercase h-fit" />
            </div>
        </div>
    </div>
</template>

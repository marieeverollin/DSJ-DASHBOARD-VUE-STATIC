<template>
    <div class="event-form-container relative flex flex-col md:flex-row bg-white rounded-2xl shadow-sm">
        ...
        <div class="main-content flex flex-col w-full gap-y-5 p-4 pb-48 md:pb-4 lg:p-12">
            <h2 class="filterSelected text-xl uppercase text-dsj-yellow font-normal text-center md:text-left">Add New
                Event</h2>
            <EventInformation />
            <EventDates />
            <EventLocation />
        ...
        <div
            class="bottom-links flex flex-col gap-y-5 p-5 fixed bottom-0 left-0 right-0 m-auto bg-white shadow-sm md:hidden">

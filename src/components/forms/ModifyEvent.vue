<template>
    <div class="event-form-container relative flex flex-col md:flex-row bg-white rounded-2xl shadow-sm">
        ...
        <div class="bottom-links flex flex-col gap-y-5 p-5 fixed bottom-0 left-0 right-0 m-auto shadow-sm bg-white md:hidden">
